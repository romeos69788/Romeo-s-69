/*
 * SHT3x / SHT4x on I2C_NUM_0 shared with GT911 — same legacy driver as ESP32_Display_Panel BusI2C.
 * Copied from thermostat-ui-demo for romeos-display-v4 (room T/RH on Screen1).
 */
