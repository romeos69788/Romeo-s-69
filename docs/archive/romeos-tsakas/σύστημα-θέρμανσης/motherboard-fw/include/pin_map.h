...
// --- INMP441 I2S (CN1) — CONTROL BOARD v1.0 PCB (EasyEDA 22/03/2026) ---
static constexpr int PIN_MIC_I2S_BCLK = 12;  // CN1-3 I2S_BCLK → H2-13 IO12 (R31)
static constexpr int PIN_MIC_I2S_WS   = 26;  // CN1-4 I2S_LRCK → H2-10 IO26 (R30→GND)
static constexpr int PIN_MIC_I2S_SD   = 27;  // CN1-5 I2S_SD   → H2-11 IO27
// GPIO26/27 = REL_K2/K3 στο ίδιο PCB — σύγκρουση hardware· mic bench: μην οδηγείς K2/K3 ως OUTPUT.

/** v1.0 PCB: CN1 I2S μοιράζεται GPIO με ρελέ K2/K3. */
inline bool pin_map_mic_shares_relay_gpio(int gpio)
{
    return gpio == PIN_MIC_I2S_WS || gpio == PIN_MIC_I2S_SD;
}

inline bool pin_map_relay_channel_mic_shared(int ch)
{
    return ch == 2 || ch == 3;
}
