/*
 * romeos-display-v4 — EEZ Studio export «central_screen» (800×480).
 * Setpoint bar, home Wi‑Fi status, NTP clock/date, room SHT, alarm buzzer.
 */
...
void setup()
{
    ...
    ui_init();
    romeos_disable_ui_scroll(objects.central_screen);
    romeos_setpoint_ui_init();
