/*
 * romeos-display-v4 — EEZ Studio export «othoni_7» (800×480).
 * Setpoint bar, home/boiler Wi‑Fi status, NTP clock/date, room/outdoor SHT, alarm buzzer.
 */
...
void setup()
{
    ...
    Serial.println();
    Serial.println("========================================");
    Serial.println("*** ROMEOS-DISPLAY-V4 / othoni_7 ***");
    Serial.println("========================================");
