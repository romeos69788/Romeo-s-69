...
typedef struct __attribute__((packed)) {
    ...
    int16_t outdoor_c_x10;        /* DHT CN5 */
    int16_t solar_c_x10;          /* MAX31865 */
    int16_t boiler_c_x10;         /* DS18 δοχείο CN4 */
    ...
    /** v1: spare. v2: + setpoint. bit0=1: placeholders solar/boiler/supply/return (δεξιά «--»). bit1=1: outdoor CN5 DHT live (OUT corner). */
