 ...
 */
/**
 * @file   BOARD_UEDX80480070E_WB_A.h
 * @brief  Configuration file for Viewe UEDX80480070E-WB-A
 * @author Viewe@VIEWESMART
 * @link   https://viewedisplay.com/product/esp32-7-inch-800x480-rgb-ips-tft-display-touch-screen-arduino-lvgl-uart/
 *
 * Project override (thermostat-ui-demo): same ST7262 / pinout as stock Viewe header, but RGB timings
 * aligned with Jingcai JC8048W550C (800x480 ST7262): 16 MHz PCLK and conservative porch values.
 * Stock Viewe used 25 MHz — if the panel shows vertical noise / corrupted tiles, slower PCLK often helps.
 * Include path puts this file before ESP32_Display_Panel's copy (see platformio.ini -I src/board_override).
 */
 ...
 */
    ...
    /* For refresh panel (RGB) — tuned vs stock Viewe (25 MHz): 16 MHz + Jingcai ST7262 porch set */
 ...
 */
    ...
    /* For host */
    /* 100 kHz: πιο ανεκτικό με Dupont + SHT παράλληλα στο ίδιο bus με GT911 (400 kHz συχνά CRC/timeout). */
