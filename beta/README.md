...
**Προαιρετικές κλέμες (hardware wired · firmware standby rev A):** **OPT1-CURRENT** · **OPT2/3-WATER-T** · **OPT4-WATER-FLOW** — βλ. [`../docs/BETA-OPT-HARDWARE-MAP.md`](../docs/BETA-OPT-HARDWARE-MAP.md)
...
### Πίνακας ρελέ — ✓ κλειδωμένο 2026-07-12
...
| **K2** | Κυκλοφορητής 2 |
| **K3** | Κυκλοφορητής 3 |
| **K4** | Κυκλοφορητής κλειστού κυκλώματος ηλιακού |
| **K5** | Τρίοδη βάνα (3-way) |
| **K6** | Αντλία θερμότητας (HP) |
| **K7** | Ηλεκτ. αντίσταση (4 kW) |
| **K8** | **Standby / spare** (silk **ST-BY**) |

**Doc:** [`../docs/BETA-RELAY-MAP.md`](../docs/BETA-RELAY-MAP.md)
...
- [`../docs/BETA-REV-A-REVIEW-2026-07-12.md`](../docs/BETA-REV-A-REVIEW-2026-07-12.md)
- [`../docs/BETA-RELAY-MAP.md`](../docs/BETA-RELAY-MAP.md) — **U1–U4 · K1–K8 · GPIO**
